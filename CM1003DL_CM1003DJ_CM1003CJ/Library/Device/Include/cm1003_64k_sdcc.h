...
/*  cm1003_64k_SDCC.H                                                                                        */
/*                                                                                                         */
/*  Header file of Nuvoton CM1003 32k Series for SDCC                                                        */
/***********************************************************************************************************/
#include "sfr_macro_cm1003_64k.h"

/******************************************************************************/
/*                         Macro define header files                          */
/******************************************************************************/

/* cm1003_64k SFR BYTE page 0  */
__sfr __at  (0x80)  P0        ;
__sfr __at  (0x81)  SP        ;
__sfr __at  (0x82)  DPL       ;
__sfr __at  (0x83)  DPH       ;
...
/* cm1003_64k       SFR BYTE page 1  */

__sfr __at  (0x89)  P4M1      ;
__sfr __at  (0x8A)  P4M2      ;
__sfr __at  (0x8B)  P4SR      ;
__sfr __at  (0x8C)  P4S       ;

__sfr __at  (0x97)  P5UP      ;

__sfr __at  (0x99)  P5M1      ;
__sfr __at  (0x9A)  P5M2      ;
__sfr __at  (0x9B)  P5SR      ;
__sfr __at  (0x9C)  P5S       ;
...
__sfr __at  (0x9E)  P4DW      ;
__sfr __at  (0x9F)  P5DW      ;
...
/*  P4  */  
__sbit  __at (0xE8+7) P47      ; // P4^7
__sbit  __at (0xE8+6) P46      ; // P4^6
__sbit  __at (0xE8+5) P45      ; // P4^5
__sbit  __at (0xE8+4) P44      ; // P4^4
__sbit  __at (0xE8+3) P43      ; // P4^3
__sbit  __at (0xE8+2) P42      ; // P4^2
__sbit  __at (0xE8+1) P41      ; // P4^1
__sbit  __at (0xE8+0) P40      ; // P4^0

/*  P5  */  
__sbit  __at (0xE8+7) P57      ; // P5^7
__sbit  __at (0xE8+6) P56      ; // P5^6
__sbit  __at (0xE8+5) P55      ; // P5^5
__sbit  __at (0xE8+4) P54      ; // P5^4
__sbit  __at (0xE8+3) P53      ; // P5^3
__sbit  __at (0xE8+2) P52      ; // P5^2
__sbit  __at (0xE8+1) P51      ; // P5^1
__sbit  __at (0xE8+0) P50      ; // P5^0
