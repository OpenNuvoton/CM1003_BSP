...
/* cm1003_64k_iar.h                                                           */
/*                                                                          */
/* Header file for Nuvoton CM1003 IAR format                                  */
/* -------------------------------------------------------------------------*/
...
__sfr __no_init volatile unsigned char P4M1           @ 0x89; 
__sfr __no_init volatile unsigned char P4M2           @ 0x8A;
__sfr __no_init volatile unsigned char P4SR           @ 0x8B;
__sfr __no_init volatile unsigned char P4S            @ 0x8C;

__sfr __no_init volatile unsigned char P5UP           @ 0x97;

__sfr __no_init volatile unsigned char P5M1           @ 0x99;
__sfr __no_init volatile unsigned char P5M2           @ 0x9A;
__sfr __no_init volatile unsigned char P5SR           @ 0x9B;
__sfr __no_init volatile unsigned char P5S            @ 0x9C;
...
__sfr __no_init volatile unsigned char P4DW           @ 0x9E;
__sfr __no_init volatile unsigned char P5DW           @ 0x9F;
