...
/******************************************************************************/
#include "function_define_cm1003_64k.h"
#include "adc.h"
#include "bod.h"
#include "capture.h"
#include "common.h"
...
/**** PWM0CON0  D8H  PAGE 0 ****/
#define set_PWM0CON0_PWM0RUN             SFRS=0;PWM0CON0|=0x80
...
#define set_PWM0CON0_PWM3RUN             SFRS=0;PWM0CON0|=0x08
#define set_PWM0CON0_PWM2RUN             SFRS=0;PWM0CON0|=0x04
#define set_PWM0CON0_PWM1RUN             SFRS=0;PWM0CON0|=0x02
#define set_PWM0CON0_P33FBINEN           SFRS=0;PWM0CON0|=0x01

#define clr_PWM0CON0_PWM0RUN             SFRS=0;PWM0CON0&=0x7F
...
#define clr_PWM0CON0_PWM3RUN             SFRS=0;PWM0CON0&=0xF7
#define clr_PWM0CON0_PWM2RUN             SFRS=0;PWM0CON0&=0xFB
#define clr_PWM0CON0_PWM1RUN             SFRS=0;PWM0CON0&=0xFD
#define clr_PWM0CON0_P33FBINEN           SFRS=0;PWM0CON0&=0xFE
...
/**** P4  E8H  PAGE 1 ****/
#define set_P4_7                         SFRS=1;P4|=0x80
#define set_P4_6                         SFRS=1;P4|=0x40
#define set_P4_5                         SFRS=1;P4|=0x20
#define set_P4_4                         SFRS=1;P4|=0x10
#define set_P4_3                         SFRS=1;P4|=0x08
#define set_P4_2                         SFRS=1;P4|=0x04
#define set_P4_1                         SFRS=1;P4|=0x02
#define set_P4_0                         SFRS=1;P4|=0x01

#define clr_P4_7                         SFRS=1;P4&=0x7F
#define clr_P4_6                         SFRS=1;P4&=0xBF
#define clr_P4_5                         SFRS=1;P4&=0xDF
#define clr_P4_4                         SFRS=1;P4&=0xEF
#define clr_P4_3                         SFRS=1;P4&=0xF7
#define clr_P4_2                         SFRS=1;P4&=0xFB
#define clr_P4_1                         SFRS=1;P4&=0xFD
#define clr_P4_0                         SFRS=1;P4&=0xFE

/**** P5  E8H  PAGE 2 ****/
#define set_P5_7                         SFRS=2;P5|=0x80
#define set_P5_6                         SFRS=2;P5|=0x40
#define set_P5_5                         SFRS=2;P5|=0x20
#define set_P5_4                         SFRS=2;P5|=0x10
#define set_P5_3                         SFRS=2;P5|=0x08
#define set_P5_2                         SFRS=2;P5|=0x04
#define set_P5_1                         SFRS=2;P5|=0x02
#define set_P5_0                         SFRS=2;P5|=0x01

#define clr_P5_7                         SFRS=2;P5&=0x7F
#define clr_P5_6                         SFRS=2;P5&=0xBF
#define clr_P5_5                         SFRS=2;P5&=0xDF
#define clr_P5_4                         SFRS=2;P5&=0xEF
#define clr_P5_3                         SFRS=2;P5&=0xF7
#define clr_P5_2                         SFRS=2;P5&=0xFB
#define clr_P5_1                         SFRS=2;P5&=0xFD
#define clr_P5_0                         SFRS=2;P5&=0xFE
...
/**** P4UP  96H  PAGE 2 ****/
#define set_P4UP_7                       SFRS=2;P4UP|=0x80
#define set_P4UP_6                       SFRS=2;P4UP|=0x40
#define set_P4UP_5                       SFRS=2;P4UP|=0x20
#define set_P4UP_4                       SFRS=2;P4UP|=0x10
#define set_P4UP_3                       SFRS=2;P4UP|=0x08
#define set_P4UP_2                       SFRS=2;P4UP|=0x04
#define set_P4UP_1                       SFRS=2;P4UP|=0x02
#define set_P4UP_0                       SFRS=2;P4UP|=0x01

#define clr_P4UP_7                       SFRS=2;P4UP&=0x7F
#define clr_P4UP_6                       SFRS=2;P4UP&=0xBF
#define clr_P4UP_5                       SFRS=2;P4UP&=0xDF
#define clr_P4UP_4                       SFRS=2;P4UP&=0xEF
#define clr_P4UP_3                       SFRS=2;P4UP&=0xF7
#define clr_P4UP_2                       SFRS=2;P4UP&=0xFB
#define clr_P4UP_1                       SFRS=2;P4UP&=0xFD
#define clr_P4UP_0                       SFRS=2;P4UP&=0xFE
...
/**** P4DW  9EH  PAGE 2 ****/
#define set_P4DW_7                       SFRS=2;P4DW|=0x80
#define set_P4DW_6                       SFRS=2;P4DW|=0x40
#define set_P4DW_5                       SFRS=2;P4DW|=0x20
#define set_P4DW_4                       SFRS=2;P4DW|=0x10
#define set_P4DW_3                       SFRS=2;P4DW|=0x08
#define set_P4DW_2                       SFRS=2;P4DW|=0x04
#define set_P4DW_1                       SFRS=2;P4DW|=0x02
#define set_P4DW_0                       SFRS=2;P4DW|=0x01

#define clr_P4DW_7                       SFRS=2;P4DW&=0x7F
#define clr_P4DW_6                       SFRS=2;P4DW&=0xBF
#define clr_P4DW_5                       SFRS=2;P4DW&=0xDF
#define clr_P4DW_4                       SFRS=2;P4DW&=0xEF
#define clr_P4DW_3                       SFRS=2;P4DW&=0xF7
#define clr_P4DW_2                       SFRS=2;P4DW&=0xFB
#define clr_P4DW_1                       SFRS=2;P4DW&=0xFD
#define clr_P4DW_0                       SFRS=2;P4DW&=0xFE

/**** P5DW  9FH  PAGE 2 ****/
#define set_P5DW_7                       SFRS=2;P5DW|=0x80
#define set_P5DW_6                       SFRS=2;P5DW|=0x40
#define set_P5DW_5                       SFRS=2;P5DW|=0x20
#define set_P5DW_4                       SFRS=2;P5DW|=0x10
#define set_P5DW_3                       SFRS=2;P5DW|=0x08
#define set_P5DW_2                       SFRS=2;P5DW|=0x04
#define set_P5DW_1                       SFRS=2;P5DW|=0x02
#define set_P5DW_0                       SFRS=2;P5DW|=0x01

#define clr_P5DW_7                       SFRS=2;P5DW&=0x7F
#define clr_P5DW_6                       SFRS=2;P5DW&=0xBF
#define clr_P5DW_5                       SFRS=2;P5DW&=0xDF
#define clr_P5DW_4                       SFRS=2;P5DW&=0xEF
#define clr_P5DW_3                       SFRS=2;P5DW&=0xF7
#define clr_P5DW_2                       SFRS=2;P5DW&=0xFB
#define clr_P5DW_1                       SFRS=2;P5DW&=0xFD
#define clr_P5DW_0                       SFRS=2;P5DW&=0xFE
